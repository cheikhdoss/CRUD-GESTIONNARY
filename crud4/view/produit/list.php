...
<ul>
<li><button><a href="?controller=produit&&action=add">ajouter un produit</a></button></li>
...
<li><a href="?controller=users">liste des utilisateur</a></li>
    ...
    <?php while( $p = pg_fetch_assoc($produits)){ ?>
        ...
        <tr class="roro">
            ...
            <td><?= $p['commentaire'] ?></td>
            <td>
                <button class="btnz"><a href="?controller=produit&&action=delete&&id=<?= $p['id'] ?>">Delete</a></button>
                <button class="btn"><a href="?controller=produit&&action=maj&&id=<?= $p['id'] ?>">Update</a></button>
            </td>
        </tr>
        <section class="sec">
    <?php } ?>    
